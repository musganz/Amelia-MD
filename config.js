...
global.mods = []
global.prems = []
global.nomorbot = '6283836042943'
global.nameown =  'mustofa'
global.nomorown = '6283836042943'
global.nomorown1 = '6283836042943'
global.nomorown2 = '6283836042943'
global.nomorwa = '0'
global.limitawal = {
...
global.author = 'mustofa' //ganti aja cuyyy
global.namebot = '​musbot' //nama bot luh
global.wm = 'mus' //ganti aja
global.media = 'https://telegra.ph/file/5d45a3d1e12726d98c5e4.jpg' //bebas
global.wm =  'mus' //wm nyaa kocak
global.watermark = wm //bebas
global.wm2 = 'mus' //ganti ajaa 
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`//ga usah dehhh 
global.bottime = `T I M E : ${wktuwib}` //ini juga ga usah 
global.titlebot = `mus` //gantu aja
global.stickpack = 'mus' //ganti 
global.stickauth = `mus` //gantii 
global.week = `${week} ${date}`
global.wibb = `${wktuwib}`
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ OWNER INFO ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.nameown1= 'mustofa' //ganti 
global.nameown2 = 'mustofa' //ganti 
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ MEDIA LINK ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
